              ...
              <form action="#" className="space-y-6 w-ful">
                ...
                <div>
                  <Link href="/resetpassword">
                    <button
                      type="submit"
                      className="w-full px-4 py-2 font-medium text-center text-white bg-[#1F5780] transition-colors duration-200 rounded-md hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1"
                    >
                      Send
                    </button>
                  </Link>
