...
function Login() {
	...
	const validateForm = () => {
		...
		if (!userName) {
			...
			errors.userName =
				"Username is invalid! It must start with an alphabetic character.";
		}
				...
				>
					<div className="w-[100%] p-5 h-full  m-auto ">
						...
						<div className="py-2 pt-6">
							{error ? (
								<MessageHandler type={error?.type} message={error?.message} />
							) : (
								""
							)}
							{success ? (
						...
						>
							<div className="mb-4">
								...
								<input
									...
									className={`bg-white text-sky-900 border border-sky-900 text-sm rounded w-full p-2.5 ${
										errors.userName ? "border-red-600 text-red-600 text-sm" : ""
									}`}
							...
							<div className="mb-4">
								...
								<input
									...
									required
									className={`bg-white text-sky-900 border border-sky-900 text-sm rounded w-full p-2.5 ${
										errors.password ? "border-red-600 text-red-600 text-sm" : ""
									}`}
