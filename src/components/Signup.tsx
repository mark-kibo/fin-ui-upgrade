        ...
        <form>
					<div className="grid gap-4 mb-2 sm:grid-cols-2 ">
						<div>
							<label
								htmlFor="name"
								className="block mb-2 text-[#1F5780] text-sm font-medium dark:text-white"
							>
								First Name
							</label>
							<input
						...
						<div>
							<label
								htmlFor="name"
								className="block mb-2 text-sm text-[#1F5780] font-medium dark:text-white"
							>
								Last Name
							</label>
						...
						<div className="mb-1">
							...
							<input
								...
								className={`bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 ${
									errors.phoneNumber
										? "border-red-500 text-red-500 text-sm"
										: ""
								}`}
						...
						<div>
							<label
								htmlFor="category"
								className="block mb-2 text-sm font-medium dark:text-sky-900"
							>
								Institution Type
							</label>
							<select
					...
					<div>
						...
						<textarea
							name="request"
							id=""
							className="bg-gray-50 border mb-4 border-gray-300  text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 "
						></textarea>
					</div>
					<Link href="/login">
						<button
